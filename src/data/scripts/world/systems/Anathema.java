...
public class Anathema implements SectorGeneratorPlugin{

    @Override
    public void generate(SectorAPI sector) {
        StarSystemAPI system = sector.createStarSystem("Anathema");
        float minX = -65000f;
        float maxX = -75000f;
        float minY = -45000f;
        float maxY = 45000f;
        ...
        system.getLocation().set(RandomX, RandomY);
        ...
        SectorEntityToken A = system.addCustomEntity("CR1", "Anathema Comm Relay", "comm_relay", "cinis_of_crusaders");
        A.setCircularOrbit(star, 180f, 2900f, 365f);
        SectorEntityToken B = system.addCustomEntity("CR2", "Anathema Nav Buoy", "nav_buoy", "cinis_of_crusaders");
        ...
        PlanetAPI planet2 = system.addPlanet(
                "Planet2", star, "Beta_2", "lava_minor", 30, 110, 2850, 90
        );
        ...
        PlanetAPI planet3 = system.addPlanet(
                "Planet3", star, "Beta_3", "barren-bombarded", 80, 130, 6800, 225
        );
        ...
        PlanetAPI planet4 = system.addPlanet(
                "Planet4", star, "Beta_4", "gas_giant", 230, 275, 9500, 450
        );
        ...
        PlanetAPI planet5 = system.addPlanet(
                "Planet5", star, "Beta_5", "gas_giant", 250, 280, 12050, 650
        );
        ...
        SectorEntityToken Cusader_GATEHAULER = system.addCustomEntity("CR_Entity2",
                "Cinis Beta",
                "cr_gatehauler",
                "cinis_of_crusaders");
...
// 创建市场
        MarketAPI M01 = Global.getFactory().createMarket("CR_Entity2", Cusader_GATEHAULER.getName(), 6);
...
// 设置市场属性
        ...
        M01.setFactionId("cinis_of_crusaders");
