...
public class CrusadersRaidIntel extends BaseIntelPlugin {
    ...
    public static void addIntelIfNeeded(SectorEntityToken entity, TextPanelAPI text, boolean quiet) {
        if (getIntel(entity) == null) {
            CrusadersRaidIntel intel = new CrusadersRaidIntel(entity);
            Global.getSector().getIntelManager().addIntel(intel, quiet, text);
        }
    }

    public static CrusadersRaidIntel getIntel(SectorEntityToken entity) {
        for (IntelInfoPlugin intel : Global.getSector().getIntelManager().getIntel(CrusadersRaidIntel.class)) {
            if (((CrusadersRaidIntel)intel).getEntity() == entity) return (CrusadersRaidIntel)intel;
        }
        return null;
    }
    ...
    public CrusadersRaidIntel(SectorEntityToken entity) {
        this.entity = entity;
    }
    ...
    public void createSmallDescription(TooltipMakerAPI info, float width, float height) {
        ...
        boolean completedAtmoBattle = Global.getSector().getMemoryWithoutUpdate().get("$armaa_WFCompletedAtmoBattle") != null;
    ...
    public static boolean startExpedition(MarketAPI source, MarketAPI target,Random random) {
        ...
        CrusadersRaidExpedition blockade = new CrusadersRaidExpedition(params, bParams);
