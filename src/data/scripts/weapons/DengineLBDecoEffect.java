...
public class DengineLBDecoEffect implements EveryFrameWeaponEffectPlugin {

	public static final String ID = "goat_DengineLBDecoEffect";
	...
	public void advance(float amount, CombatEngineAPI engine, WeaponAPI weapon) {
		...
		if (ship.getEngineController().isTurningLeft() || ship.getEngineController().isStrafingRight()) {
