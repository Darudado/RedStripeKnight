...
public class PiercingarcEffect implements OnHitEffectPlugin {
    ...
    private static class ProjDeal implements DamageDealtModifier, AdvanceableListener {
        ...
        public String modifyDamageDealt(Object param, CombatEntityAPI target, DamageAPI damage, Vector2f point, boolean shieldHit) {
            ...
            if (!damaged.contains(target)) {
                if (param instanceof DamagingProjectileAPI projectile) {
                    ...
                    // 检查弹丸是否带有特定标识
                    if (projectile.getCustomData().containsKey("rs_judexterminatusSource")) {
                        int uid = (int) projectile.getCustomData().get("rs_judexterminatusSource");
        ...
        public void advance(float amount) {
            ...
            WeaponAPI weapon = originalProj.getWeapon();
            ...
            // 添加自定义数据标识来源
            newProjectile.setCustomData("rs_judexterminatusSource", UID);
