...
public class Tr6_RifleBeanEffect implements BeamEffectPlugin {
    ...
    public void advance(float amount, CombatEngineAPI engine, BeamAPI beam) {
        ...
        MagicRender.battlespace(Global.getSettings().getSprite("graphics/starscape/star2.png"), beam.getFrom(), new Vector2f(),
                ...
                0f,
                new Color(195,175,45, alpha_value1),
                true,
                0.07f,
                0f,
                0.14f);
        ...
        if (beam.getBrightness() >= 1f) {
            ...
            if (!runOnce) {
                ...
                engine.spawnProjectile(weapon.getShip(), weapon, "rs_Tr_6_arm_right_gun_rifle_proj", beam.getFrom(), weapon.getCurrAngle(), new Vector2f());
