...
public class Tr_FiverWingController_L implements EveryFrameWeaponEffectPlugin {
    ShipAPI ship;
    ...
    public void advance(float amount, CombatEngineAPI engine, WeaponAPI weapon) {
        ...
        if (!init){
            ...
            String wingId = "LWING_" + "L";
            String subwingId = "LSWING_" + "L";
            String armorwingId = "LAWING_" + "L";
