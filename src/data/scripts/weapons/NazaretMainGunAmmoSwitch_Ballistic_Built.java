 ...
 * 集成了不同弹药类型的枪口特效
 */
public class NazaretMainGunAmmoSwitch_Ballistic_Built implements EveryFrameWeaponEffectPlugin, OnFireEffectPlugin {
    private boolean useHE = false;
    private static final String STATUS_KEY = "Nazaret_MAINGUN_AMMO_BALLISTIC_BUILT_SWITCH";
