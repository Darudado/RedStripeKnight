...
public class DengineLDecoEffect implements EveryFrameWeaponEffectPlugin {

	public static final String ID = "DengineLDecoEffect";
	...
	public void advance(float amount, CombatEngineAPI engine, WeaponAPI weapon) {
		...
		if (ship.getEngineController().isTurningRight() || ship.getEngineController().isStrafingRight()) {
