...
public class Tr_Fiver_launch_firesupport implements EveryFrameWeaponEffectPlugin, OnFireEffectPlugin {
    ...
    // 添加无参构造函数
    public Tr_Fiver_launch_firesupport() {
    }
    ...
    private static void spawnShip(ShipAPI source, DamagingProjectileAPI projectile, ProjectileState state) {
        ...
        ShipAPI ship = manager.spawnShipOrWing("rs_Tr_3_Firesupport", projectile.getLocation(), projectile.getFacing(), 3);
