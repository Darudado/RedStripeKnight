...
public class RX78_GP03D_MissileEffect_Right2 implements EveryFrameWeaponEffectPlugin , OnFireEffectPlugin {
    ShipAPI parent;
    private static final String DATA_KEY_PREFIX = "rs_RX78_GP03D_";
    ...
    private static final String CANISTER_DETONATION_SOUND_ID = "dragonfire_fire";
    ...
    private static final String CANISTER_PROJECTILE_ID = "rs_RX78_GP03D_mirv1";
    private static final float CANISTER_SPLIT_DISTANCE = 650f;
    private static final float CANISTER_SPREAD_FORCE_MAX = 300f;
    private static final float CANISTER_SPREAD_FORCE_MIN = 100f;
    private static final int CANISTER_SUBMUNITIONS = 36;
    private static final String CANISTER_SUBMUNITION_WEAPON_ID = "cr_lapislull_sub";
    ...
    private static final String GUNGNIR_DETONATION_SOUND_ID = "dragonfire_fire";
    ...
    private static final String GUNGNIR_PROJECTILE_ID = "rs_RX78_GP03D_mirv2";
    private static final float GUNGNIR_SPLIT_DISTANCE = 1500f;
    private static final float GUNGNIR_SPREAD_FORCE_MAX = 80f;
    private static final float GUNGNIR_SPREAD_FORCE_MIN = 30f;
    private static final int GUNGNIR_SUBMUNITIONS = 3;
    private static final String GUNGNIR_SUBMUNITION_WEAPON_ID = "rs_petrarupt";
    ...
    public void advance(float amount, CombatEngineAPI engine, WeaponAPI weapon) {
        ShipAPI Childship = weapon.getShip();
        String WeaponID = "rs_RX78_GP03D_controller_Right2";
        WeaponAPI parentWeapon = null;
        if(Childship.getParentStation() != null) {
            parent = Childship.getParentStation();
            ...
            if(parentWeapon != null){
                if(parentWeapon.getChargeLevel() <= 0){
        ...
        while (iter.hasNext()) {
            ...
            if (!shouldSplit) {
                ...
                java.util.List<ShipAPI> checkList = engine.getShips();
