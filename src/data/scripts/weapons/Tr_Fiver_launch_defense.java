...
public class Tr_Fiver_launch_defense implements EveryFrameWeaponEffectPlugin, OnFireEffectPlugin {
    ...
    // 添加无参构造函数
    public Tr_Fiver_launch_defense() {
    }
    ...
    private static void spawnShip(ShipAPI source, DamagingProjectileAPI projectile, ProjectileState state) {
        ...
        ShipAPI ship = manager.spawnShipOrWing("rs_Tr_3_Defense", projectile.getLocation(), projectile.getFacing(), 3);
