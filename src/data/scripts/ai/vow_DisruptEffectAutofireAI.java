...
import data.scripts.utils.CR_finders;
...
public class vow_DisruptEffectAutofireAI implements AutofireAIPlugin {
    ...
    public vow_DisruptEffectAutofireAI(WeaponAPI weapon) {
        this.weapon = weapon;
    ...
    public void advance(float amount) {
        ...
        if (interval.intervalElapsed()) {
            ...
            if (targetMissile == null){
                targetFighter = CR_finders.nearestEnemyFighterInWeaponArc(weapon);
            }
        }
    }
