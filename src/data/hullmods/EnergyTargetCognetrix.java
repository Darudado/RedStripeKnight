...
public class EnergyTargetCognetrix extends BaseHullMod {

    public static float RANGE_BONUS_Ballistic = 25f;
    ...
    public void applyEffectsBeforeShipCreation(ShipAPI.HullSize hullSize, MutableShipStatsAPI stats, String id) {
        ...
        stats.getBeamPDWeaponRangeBonus().modifyPercent(id, RANGE_BONUS_Ballistic);
        stats.getBeamPDWeaponRangeBonus().modifyPercent(id, RANGE_BONUS_Ballistic);
        ...
        if (!sMod) {
            stats.getEnergyWeaponDamageMult().modifyPercent(id, SmodDamagemult);
        }
    }


    public String getDescriptionParam(int index, HullSize hullSize) {
        if (index == 0) return "" + (int) RANGE_BONUS_Ballistic + "%";
    ...
    public boolean isApplicableToShip(ShipAPI ship) {
        return !ship.getVariant().getHullMods().contains("targetingunit") &&
                ...
                !ship.getVariant().getHullMods().contains("BallisticTargetCognetrix");
    }
