...
import static data.hullmods.Tr.Tr6_Haznthley_system.refreshUIIfNeeded;

public class VOW_PiafidesSystem extends BaseHullMod {
    public static final String BASIC_HULL_ID = "vow_piafides";
    ...
    static {
        SYSTEM_CONFIGS.put(0, new SystemConfig("vow_piafides", "vow_piafidesA_selector", 1, "A"));
        SYSTEM_CONFIGS.put(1, new SystemConfig("vow_piafidesB", "vow_piafidesB_selector", 0, "B"));
        //SYSTEM_CONFIGS.put(2, new SystemConfig("vow_piafidesC", "vow_piafidesC_selector", 0, "C"));
    ...
    public void applyEffectsAfterShipCreation(ShipAPI ship, String id) {
        handleSystemSwapping(ship.getMutableStats());
    }
