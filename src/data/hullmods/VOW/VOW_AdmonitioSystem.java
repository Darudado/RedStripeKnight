...
import java.util.*;
public class VOW_AdmonitioSystem extends BaseHullMod {
    public static final String BASIC_HULL_ID = "vow_admonitio";
    ...
    static {
        SYSTEM_CONFIGS.put(0, new SystemConfig("vow_admonitio", "vow_admonitioA_selector", 1, "A"));
        SYSTEM_CONFIGS.put(1, new SystemConfig("vow_admonitioB", "vow_admonitioB_selector", 0, "B"));
        //SYSTEM_CONFIGS.put(2, new SystemConfig("vow_admonitioC", "vow_admonitioC_selector", 0, "C"));
