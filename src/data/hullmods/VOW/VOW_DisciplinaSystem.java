...
import java.util.*;
public class VOW_DisciplinaSystem extends BaseHullMod {
    public static final String BASIC_HULL_ID = "vow_disciplina";
    ...
    static {
        SYSTEM_CONFIGS.put(0, new SystemConfig("vow_disciplina", "vow_disciplinaA_selector", 1, "A"));
        SYSTEM_CONFIGS.put(1, new SystemConfig("vow_disciplinaB", "vow_disciplinaB_selector", 0, "B"));
