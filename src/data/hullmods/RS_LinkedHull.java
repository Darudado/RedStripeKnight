...
public class RS_LinkedHull extends BaseHullMod {
    ...
    private static final float DEFAULT_ORIGINAL_MASS = 13550.0F;
    private static final int DEFAULT_ORIGINAL_ENGINES = 15;
    ...
    private static void advanceParent(ShipAPI parent, List<ShipAPI> children) {
        ...
        if (stats != null) {
            stats.getAcceleration().modifyMult("rs_LinkedHull", enginePerformance);
            stats.getDeceleration().modifyMult("rs_LinkedHull", enginePerformance);
            stats.getTurnAcceleration().modifyMult("rs_LinkedHull", enginePerformance);
            stats.getMaxTurnRate().modifyMult("rs_LinkedHull", enginePerformance);
            stats.getMaxSpeed().modifyMult("rs_LinkedHull", enginePerformance);
            stats.getZeroFluxSpeedBoost().modifyMult("rs_LinkedHull", enginePerformance);
        }
    }

    private static float calculateThrustPerEngine(String hullId) {
        if (hullId.equals("rs_byzantine")) {
    ...
    private boolean isModule(String hullId) {
        return hullId.equals("rs_byzantine_armor_right") ||
                hullId.equals("rs_byzantine_armor_left") ||
                hullId.equals("rs_byzantine_left_deck") ||
                hullId.equals("rs_byzantine_right_deck") ||
                hullId.equals("rs_byzantine_engine_right") ||
                hullId.equals("rs_byzantine_engine_left");
    }
