...
public class VowerMoudleController extends BaseHullMod {
    ...
    // 机翼舰船ID配置
    private static final String LEFT_WING_SHIP_ID = "_Leftwingmoudle";
    private static final String RIGHT_WING_SHIP_ID = "_Rightwingmoudle";
