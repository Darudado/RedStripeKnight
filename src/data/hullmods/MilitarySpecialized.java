...
public class MilitarySpecialized extends BaseLogisticsHullMod {
    ...
    private static int countMods(MutableShipStatsAPI stats) {
        int count = 0;
        for (String id : MilitarySpecialized.COMBAT_MOD_IDS) {
    ...
    public void applyEffectsBeforeShipCreation(HullSize hullSize, MutableShipStatsAPI stats, String id) {
        ...
        if (installedMods > 0) {
            ...
            if (sMod) {
                stats.getFluxCapacity().modifyPercent(id, fluxBonus * 110f);
                stats.getFluxDissipation().modifyPercent(id, fluxBonus * 110f);
                stats.getWeaponTurnRateBonus().modifyPercent(id, fluxBonus * 110f);
                stats.getArmorBonus().modifyPercent(id, armorBonus * 110f);
                stats.getMaxSpeed().modifyPercent(id, speedBonus * 110f);
                stats.getSuppliesPerMonth().modifyPercent(id ,logisticsDec * 85f);
            }
        }
    }
