...
public class MSA0011Bst303E_Controlling extends BaseHullMod {
    ...
    private static final float DEFAULT_ORIGINAL_MASS = 2980.0F;
    private static final int DEFAULT_ORIGINAL_ENGINES = 13;
    ...
    private static float calculateThrustPerEngine(String hullId) {
        if (hullId.equals("rs_MSA0011(Bst)303E")) {
    ...
    private boolean isModule(String hullId) {
        return hullId.equals("rs_MSA0011(Bst)303E_subEngine_Left") ||
                hullId.equals("rs_MSA0011(Bst)303E_subEngine_Right") ||
                hullId.equals("rs_MSA0011(Bst)303E_ManEngine");
    }
