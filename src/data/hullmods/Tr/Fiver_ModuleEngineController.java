...
public class Fiver_ModuleEngineController extends BaseHullMod {

    // 动画参数
    private static final float ROTATION_SPEED = 5.0f;
    private static final float MAX_TURN_ARC = 25.0f;
    private static final float TURN_ARC1 = 15.0f;
    ...
    // 机翼舰船ID配置
    private static final String LEFT_WING_SHIP_ID = "wingEngineLeft";
    private static final String RIGHT_WING_SHIP_ID = "wingEngineRight";
    ...
    public boolean isApplicableToShip(ShipAPI ship) {
        return ship.getHullSpec().getHullId().contains("rs");
    }
}