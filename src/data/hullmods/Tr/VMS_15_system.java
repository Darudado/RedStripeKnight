...
public class VMS_15_system extends BaseHullMod {
    public static final String BASIC_HULL_ID = "vow_VMS_15";
    public static final Map<String, String> HULL_IDS = new HashMap<>();

    static {
        HULL_IDS.put("vow_VMS_15_assault_selector", "vow_VMS_15_assault");
        HULL_IDS.put("vow_VMS_15_firesupport_selector", "vow_VMS_15_firesupport");
    }
    ...
    private void rebuildHullMods(ShipAPI ship, ShipHullSpecAPI newHullSpec, String selectorHullMod, List<String> sMods) {
        ...
        variant.addMod("vow_VMS_15_system");
    }
