...
public class Tr6_Haznthley_system extends BaseHullMod {
    public static final String BASIC_HULL_ID = "rs_Tr_6_haznthley";
    public static final Map<String, String> HULL_IDS = new HashMap<>();

    static {
        HULL_IDS.put("rs_Tr_6_haznthley_support_selector", "rs_Tr_6_haznthley_support");
        HULL_IDS.put("rs_Tr_6_haznthley_assault_selector", "rs_Tr_6_haznthley_assault");
    }
    ...
    private void rebuildHullMods(ShipAPI ship, ShipHullSpecAPI newHullSpec, String selectorHullMod, List<String> sMods) {
        ...
        variant.addMod("Tr6_Haznthley_system");
    }

    /**
     * 如果需要则刷新UI
     */
    public static void refreshUIIfNeeded() {
