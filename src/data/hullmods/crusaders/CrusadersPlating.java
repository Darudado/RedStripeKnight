...
public class CrusadersPlating extends BaseHullMod {
    ...
    public void addPostDescriptionSection(TooltipMakerAPI tooltip, HullSize hullSize, ShipAPI ship, float width, boolean isForModSpec) {
        ...
        tooltip.addPara("Armor-like plating formed from the controlled leakage of energy from the advanced Crusader Core, providing %s damage reduction based on hull size and flux capacity, visible on most ships with Crusader Cores installed", opad, h, ship != null ? "" + (Math.round(ship.getMutableStats().getFluxCapacity().getModifiedValue() * mag.get(hullSize))) : "" + Math.round(250f));
        ...
        tooltip.addPara("Due to the huge amount of waste heat generated by the Crusader core, the coating can only provide half of the normal effect when overloaded or actively venting.", pad, h);
