package data.missions.rs_Vince;
...
public class MissionDefinition implements MissionDefinitionPlugin {
	...
	public void defineMission(MissionDefinitionAPI api) {
		...
		api.addToFleet(FleetSide.PLAYER, "rs_vincere_variant", FleetMemberType.SHIP, "Patientia", false);
		api.addToFleet(FleetSide.PLAYER, "rs_sophia_attact", FleetMemberType.SHIP, "Gaudium", false);
		api.addToFleet(FleetSide.PLAYER, "rs_kharybdis_Staderd", FleetMemberType.SHIP, "Gaudium", false);
		api.addToFleet(FleetSide.PLAYER, "rs_MA_01_Strike", FleetMemberType.SHIP, "Caritas", false);
		api.addToFleet(FleetSide.PLAYER, "rs_MA_01_Strike", FleetMemberType.SHIP, false);
		api.addToFleet(FleetSide.PLAYER, "rs_MA_01_Strike", FleetMemberType.SHIP, false);
		api.addToFleet(FleetSide.PLAYER, "rs_MA_01_Strike", FleetMemberType.SHIP, false);
		api.addToFleet(FleetSide.PLAYER, "rs_Tr_1_owsla_assault_Standerd", FleetMemberType.SHIP,  false);
		api.addToFleet(FleetSide.PLAYER, "rs_Tr_1_owsla_firesupport_Standerd", FleetMemberType.SHIP,  false);

		api.addToFleet(FleetSide.ENEMY, "station3_Standard", FleetMemberType.SHIP, true);
