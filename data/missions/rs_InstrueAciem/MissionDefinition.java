package data.missions.rs_InstrueAciem;
...
public class MissionDefinition implements MissionDefinitionPlugin {
	...
	public void defineMission(MissionDefinitionAPI api) {
		...
		api.addToFleet(FleetSide.PLAYER, "rs_leviathan_variant", FleetMemberType.SHIP, "Vigilantia", false);
		api.addToFleet(FleetSide.PLAYER, "rs_behemoth_variant", FleetMemberType.SHIP, "Renovatio", false);
		api.addToFleet(FleetSide.PLAYER, "rs_behemoth_variant", FleetMemberType.SHIP, "Renovatio", false);
		api.addToFleet(FleetSide.PLAYER, "rs_avaritia_variant", FleetMemberType.SHIP, "Campana", false);
		api.addToFleet(FleetSide.PLAYER, "rs_avaritia_variant", FleetMemberType.SHIP, "Hymnus", false);
